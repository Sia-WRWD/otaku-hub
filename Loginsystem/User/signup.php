...
<html>
	<head>
		<title>Otaku Page| User Sign Up</title>
	...
	<body>
		...
		<main>
			...
			<div class="form-box">
				<form action="../../connection/user/signup.con.php" method="post">
					<div class="signContainer">
						<center>
                            <img class="resize" src="../signup.gif"><br>
                            
							<h1><b>Start Using OtakuPage</b></h1>
							<p>
								Join OtakuPage to bookmark your favourite anime and manga, create your own profile, and plenty more. It's all <b>FREE<b>!!!
							</p>
						</center>
						...
						<input type="text" placeholder="Enter Username (within 8-16 characters)" name="uname" required><br>

						<label for="psw"><b>Password</b></label><br>
						<input type="password" placeholder="Enter Password" name="psw" required><br>

						<label for="repsw"><b>Re-Enter Password</b><label><br>
						<input type="password" placeholder="Re-Enter Password" name="repsw" required><br>
