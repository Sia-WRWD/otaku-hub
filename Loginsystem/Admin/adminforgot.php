...
<html>
	<head>
		<title>Otaku Page | Admin Forgot Password</title>
	...
	<body>
		...
		<main>
			...
			<div class="form-box">
				<form action="../../connection/admin/adminforgot.con.php" method="post">
					...
					<div class="clearfix" style="background-color:#f1f1f1">
						<button type="submit" name = "adminforgot-submit">Reset Forgotten Password</button>
						<button type="button" class="cancelbtn" onclick="window.location.href='http://localhost/otaku/loginsystem/admin/adminlogin.php'">Cancel</a></button>
					</div>
				</form>
