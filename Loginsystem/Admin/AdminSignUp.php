...
<script>function userValidation(){
	...
	<head>
		<title>OtakuPage | Admin Sign Up</title>
...
?>
		...
		<main>
			...
			<div class="form-box">
				<form action="../../connection/admin/adminsignup.con.php" method="post">
					<div class="signContainer">
						<center>
                            <img class="resize" src="adminsignup.gif"><br>
                            
							<h1><b>Welcome to Anime Heaven!</b></h1>
							<p>
                                <b><i>Congratulation on being one of the most powerful beings and an official veteran Weeb on OtakuPage, 
                                nobody can stop you now! Create your account now and show everyone your power!!!</i></b>
                            </p>
						</center>
						...
						<label for="uname"><b>Anime God Codename</b></label><br>
						<input type="text" placeholder="Enter Anime God Codename (within 8-16 characters)" name="uname" required><br>

						<label for="psw"><b>God Code</b></label><br>
						<input type="password" placeholder="Enter God Code" name="psw" required><br>

						<label for="repsw"><b>Re-Enter God Code</b><label><br>
						<input type="password" placeholder="Re-Enter God Code" name="repsw" required><br>
					...
					<div class="clearfix" style="background-color:#f1f1f1">
						...
						<button type="submit" class="signupbtn" name="adminsignup-submit">Sign Up</button>
					</div>
				</form>
			</div>
		</main>
