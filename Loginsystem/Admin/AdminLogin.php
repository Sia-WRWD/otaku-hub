...
<html>
	<head>
		<title>OtakuPage | Admin Login</title>
	...
	<body>
		...
		<main>
			...
			<div class="form-box">
				<form action="../../connection/admin/Adminlogin.con.php" method="post">
					<div class="loginContainer">	
						<center>
                            <h1><b><u><i>Admin Login</i></u></b></h1><br>
							<img class="resize" src="adminlogin.gif"><br>
								<div class="role">
						...
						?>
						<input type="text" placeholder="Enter Anime God Codename" name="uname" required><br>

						<label for="psw"><b>God Code</b></label><br>
						<input id="password" type="password" placeholder="Enter Password" name="psw" required><br>
					
						<label>
							<input type="checkbox" name="showpassword" onclick="ShowPassword()"><span class="chk"><b><i> Show God Code</b></i></span> <br>
								<script>
					...
					<div class="clearfix" style="background-color:#f1f1f1">
						<button type="submit" name = "adminlogin-submit">Login</button>
						<button type="button" class="cancelbtn" onclick="window.location.href='http://localhost/otaku/index/index.php'">Cancel</a></button>
						<span class="psw">Forgot <a href="http://localhost/otaku/loginsystem/admin/adminforgot.php">Password?</a></span>
					</div>
				</form>
