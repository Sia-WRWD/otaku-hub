...
<html>
	<head>
		<title>Otaku Page| Moderator Set New Password</title>
		...
		<main>
			...
			<div class="form-box">
				...
				?>
					...
					<form action="../../connection/moderator/modnew.con.php" method="post">
						...
						<div class="clearfix" style="background-color: #f1f1f1">
							<button type="submit" name="modnew-submit">Reset Password</button> 
						</div>
					</form>
				<?php
						}
