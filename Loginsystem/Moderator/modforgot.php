...
<html>
	<head>
		<title>Otaku Page | Moderator Forgot Password</title>
	...
	<body>
		...
		<main>
			...
			<div class="form-box">
				<form action="../../connection/moderator/modforgot.con.php" method="post">
					...
					<div class="clearfix" style="background-color:#f1f1f1">
						<button type="submit" name = "modforgot-submit">Reset Forgotten Password</button>
						<button type="button" class="cancelbtn" onclick="window.location.href='http://localhost/otaku/loginsystem/moderator/modlogin.php'">Cancel</a></button>
					</div>
				</form>
