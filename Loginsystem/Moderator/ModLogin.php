...
<html>
	<head>
		<title>OtakuPage | Moderator Login</title>
	...
	<body>
		...
		<main>
			...
			<div class="form-box">
				<form action="../../connection/moderator/Modlogin.con.php" method="post">
					<div class="loginContainer">
						<center>
                            <h1><b><u><i>Moderator Login</i></u></b></h1><br>
							<img class="resize" src="modlogin.gif"><br>
								<div class="role">
						...
						?>
						<input type="text" placeholder="Enter FBICodename" name="uname" required><br>

						<label for="psw"><b>FBI Code</b></label><br>
						<input id="password" type="password" placeholder="Enter FBI Code" name="psw" required><br>
					
						<label>
							<input type="checkbox" name="showpassword" onclick="ShowPassword()"><span class="chk"><b><i> Show FBI Code</i></b></span> <br>
								<script>
					...
					<div class="clearfix" style="background-color:#f1f1f1">
						<button type="submit" name = "modlogin-submit">Login</button>
						<button type="button" class="cancelbtn" onclick="window.location.href='http://localhost/otaku/index/index.php'">Cancel</a></button>
						<span class="psw">Forgot <a href="http://localhost/otaku/loginsystem/moderator/modforgot.php">Password?</a></span>
					</div>
				</form>
