...
<head>
    ...
    <title>OtakuPage| HomePage</title>
</head>
                ...
                <div class="nav-links">
                    <ul>
                        <li class="nav-link" style="--i: .6s">
                            <a href="http://localhost/hfyc/home/home.php">Home</a>
                        </li>
            ...
            <div class="log-sign" style="--i: 1.8s">
                <?php
                    if (isset($_SESSION['id'])) {
                        echo '<form class ="log-sign" style="--i: 1.8s" action="../connection/logout.con.php" method="post">
...
<br>
        ...
        <div class="slideshow-container">
            ...
            <div class="mySlides fade">
                ...
                <img src="umaru.png" style="width:100%">
                <div class="text"><a href="http://localhost/otaku/content/Anime/HUC/HUC.php" target="blank" style="color: magenta">Himouto! Umaru-chan</a></div>
            </div>

            <div class="mySlides fade">
                <div class="numbertext">2 / 5</div>
                <img src="dkaa.png" style="width:100%">
                <div class="text"><a href="http://localhost/otaku/content/Anime/DKA/DKA.php" target="blank" style="color: magenta">The Misfit of Demon King Academy</a></div>
            </div>

            <div class="mySlides fade">
                <div class="numbertext">3 / 5</div>
                <img src="saou.png" style="width:100%">
                <div class="text"><a href="http://localhost/otaku/content/Anime/SAO/SAO.php" target="blank" style="color: magenta">Sword Art Online: Alicization - <br>War of Underworld</a></div>
            </div>

            <div class="mySlides fade">
                <div class="numbertext">4 / 5</div>
                <img src="bnhaa.png" style="width:100%">
                <div class="text"><a href="http://localhost/otaku/content/Anime/BNHA/BNHA.php" target="blank" style="color: magenta">Boku no Hero Academia</a></div>
            </div>

            <div class="mySlides fade">
                <div class="numbertext">5 / 5</div>
                <img src="knightss.png" style="width:100%">
                <div class="text"><a href="http://localhost/otaku/content/Anime/KNM/KNM.php" target="blank" style="color: magenta">Knight's & Magic</a></div>
            </div>
