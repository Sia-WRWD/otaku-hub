...
if (isset($_POST["modforgot-submit"])) {
    
    $selector = bin2hex(random_bytes(8));
    $token = random_bytes(32);

    $url = "http://localhost/otaku/loginsystem/moderator/modnew.php?selector=" . $selector . "&validator=" . bin2hex($token); 
    ...
    header("Location: ../../loginsystem/moderator/modforgot.php?reset=success");
