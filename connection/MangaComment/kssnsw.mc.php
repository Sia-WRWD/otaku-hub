...
function getComments($conn) {
    $sql = "SELECT * FROM comments WHERE CommentAnime='KSSNSW' and PosID='User' ";
    $result = $conn->query($sql);
    $sql3 = "SELECT * FROM comments WHERE CommentAnime='KSSNSW' and PosID='Admin' ";
    $result3 = $conn->query($sql3);
    $sql5 = "SELECT * FROM comments WHERE CommentAnime='KSSNSW' and PosID='Moderator' ";
    $result5 = $conn->query($sql5);



    while ($row3 = $result3->fetch_assoc()) { //Retrieve Admin Comments
        $id = $row3['UserID'];
    ...
    while ($row5 = $result5->fetch_assoc()) { //Retrieve Moderator Comments
        $id = $row5['UserID'];
    ...
    while ($row = $result->fetch_assoc()) { //Retrieve User's Comments
        $id = $row['UserID'];
