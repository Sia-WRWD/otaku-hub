...
function getComments($conn) {
    $sql = "SELECT * FROM comments WHERE CommentAnime='OPM' and PosID='User' ";
    $result = $conn->query($sql);
    $sql3 = "SELECT * FROM comments WHERE CommentAnime='OPM' and PosID='Admin' ";
    $result3 = $conn->query($sql3);
    $sql5 = "SELECT * FROM comments WHERE CommentAnime='OPM' and PosID='Moderator' ";
