...
function getComments($conn) {
    $sql = "SELECT * FROM comments WHERE CommentAnime='UCWA'";
    $sql = "SELECT * FROM comments WHERE CommentAnime='UCWA' and PosID='User' ";
    $result = $conn->query($sql);
    $sql3 = "SELECT * FROM comments WHERE CommentAnime='UCWA' and PosID='Admin' ";
    $result3 = $conn->query($sql3);
    $sql5 = "SELECT * FROM comments WHERE CommentAnime='UCWA' and PosID='Moderator' ";
