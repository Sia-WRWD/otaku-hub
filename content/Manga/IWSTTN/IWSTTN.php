<?php
        ...
        include '../../../connection/MangaComment/iwsttn.mc.php';
?>
...
<head>
    ...
    <title>OtakuPage| Isekai wa Smartphone to Tomo ni</title>
</head>
    ...
    <br>
     ...
     <body>
		...
		<div class="content-box" style="width:950px; margin:0 auto;">
            <div class="title"><h1>Isekai wa Smartphone to Tomo ni</h1></div>
			<div class="image"><br><img src="Images/cover.png" alt="main_cover" style="width:350px;height:450px;"></div>
            <div class="desc"><br>In a thoughtless blunder, God accidentally strikes down Touya Mochizuki with a stray bolt of lightning! 
                                  As an apology, God offers him one wish and the chance to live again in a magical fantasy world. Touya 
                                  happily accepts the offer and, for his one wish, asks only to keep his smartphone with him as he begins 
                                  his journey into this mysterious world.
                                  <br></br>
                                  Starting over in this new world, Touya finds it is filled with magic—which he has an affinity for—and 
                                  cute girls vying for his attention. These girls—the twins Linze and Elze Silhoueska, Yumina Urnea Belfast, 
                                  Leen, and Yae Kokonoe—provide Touya with no end of romantic frustrations, but also companionship as he 
                                  discovers the secrets of this new world.              
                <br></br>               
                    ...
                    if (isset($_SESSION['id'])) {
                        $pos = $_SESSION['position'];
                         echo "<form method='POST' action='".setComments($conn)."'>
                                    <input type='hidden' name ='anime' value ='IWSTTN'>
