<?php
        ...
        include '../../../connection/MangaComment/gb.mc.php';
?>
...
<head>
    ...
    <title>OtakuPage| Grand Blue</title>
</head>
    ...
    <br>
     ...
     <body>
		...
		<div class="content-box" style="width:950px; margin:0 auto;">
            <div class="title"><h1>Grand Blue</h1></div>
			<div class="image"><br><img src="Images/cover.png" alt="main_cover" style="width:350px;height:450px;"></div>
            <div class="desc"><br>Among the seaside town of Izu's ocean waves and rays of shining sun, Iori Kitahara is just beginning his 
                                  ...
                                  <br></br>
                                  But things don't exactly go according to plan. Upon entering the shop, he encounters a group of rowdy, 
                                  naked upperclassmen, who immediately coerce him into participating in their alcoholic activities. Though 
                                  unwilling at first, Iori quickly gives in and becomes the heart and soul of the party. Unfortunately, this 
                                  earns him the scorn of his cousin, Chisa Kotegawa, who walks in at precisely the wrong time. Undeterred, 
                                  Iori still vows to realize his ideal college life, but will things go according to plan this time, or will 
                                  his situation take yet another dive?       
                <br></br>               
                    ...
                    if (isset($_SESSION['id'])) {
                        $pos = $_SESSION['position'];
                         echo "<form method='POST' action='".setComments($conn)."'>
                                    <input type='hidden' name ='anime' value ='GB'>
