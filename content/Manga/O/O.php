<?php
        ...
        include '../../../connection/MangaComment/o.mc.php';
?>
...
<head>
    ...
    <title>OtakuPage| Overlord</title>
</head>
    ...
    <br>
     ...
     <body>
		...
		<div class="content-box" style="width:950px; margin:0 auto;">
            <div class="title"><h1>Overlord</h1></div>
			<div class="image"><br><img src="Images/cover.png" alt="main_cover" style="width:350px;height:450px;"></div>
            <div class="desc"><br>Yggdrasil is a virtual reality game renowned for the freedom it offers its players. After a simple tutorial, 
                                  players are left to explore the world and can customize anything and everything, from their classes to their 
                                  weapons. However, in the year 2138, the game sees its final hours as its servers shut down at midnight.
                                  <br></br>
                                  Momonga, a devoted player of Yggdrasil, decides to spend the game's last hours inside his guild, 
                                  Ainz Ooal Gown. Strangely, at the stroke of midnight, the game does not log him out. Instead, Momonga 
                                  finds himself transported to another world, one that is seemingly identical to that of Yggdrasil. 
                                  Facing an already abnormal situation, he discovers that the NPCs have gained sentience.
                                  <br></br>
                                  Trapped in his avatar's skeletal body and desperate to uncover the cause of his predicament and find other 
                                  players like him, Momonga sets out to take control of the new world with the help of his loyal subjects.        
                <br></br>               
                    ...
                    if (isset($_SESSION['id'])) {
                        $pos = $_SESSION['position'];
                         echo "<form method='POST' action='".setComments($conn)."'>
                                    <input type='hidden' name ='anime' value ='O'>
