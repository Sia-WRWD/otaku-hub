...
<head>
    ...
    <title>OtakuPage| Edit Comment</title>
</head>
...
?>
    ...
    echo "<form class ='revbx' method='POST' action='".editComments($conn)."'>
            <input type='hidden' name ='cid' value ='".$cid."'>
            <input type='hidden' name ='id' value ='".$id."'>
            <input type='hidden' name ='date' value ='".$date."'>
            <br><textarea class='txta' name='message'>".$message."</textarea><br>
            <button class='btn transparent' type='submit' name='commentSubmit'>Edit</button>
            <br></br>
         </form>";
    ?>

    <center>
        <img src= "Muda.gif" width="50%">
    </center>
