<?php
        ...
        include '../../../connection/AnimeComment/dka.ac.php';
?>
...
<head>
    ...
    <title>OtakuPage| The Misfit of Demon King Academy</title>
</head>
    ...
    <br>
     ...
     =<body>
		 ...
		 <div class="content-box" style="width:950px; margin:0 auto;">
             <div class="title"><h1>The Misfit of Demon King Academy</h1></div>
			 <div class="image"><br><img src="Images/cover.png" alt="main_cover" style="width:350px;height:450px;"></div>
			 <div class="desc"><br> After leading a bloodthirsty war against humankind for so long, the demon king Anoth has grown weary of 
                                    it all and wishes to make peace, but the only thing that will achieve that is his death. While inviting 
                                    the human hero Kanon to come to his castle to kill him, Anoth formulates a plan to separate humans and 
                                    demons for a thousand years, while scattering his descendants so that he may reincarnate into hopefully 
                                    a more peaceful world.
                                    <br></br>
                                    After being slain by Kanon, Anoth awakes 2000 years later as the child of a human couple, Isabella and 
                                    Gusta, where everything seems to have gone as planned – there’s no signs of war, and humans and demons 
                                    freely intermingle in everyday life. However, underneath the surface not everything is as nice as it seems, 
                                    as demon society is wracked by class discrimination, with pureblood demons being viewed as better than those 
                                    with mixed human and demon parentage; while Anoth’s great deeds of conquest have been muddled with time, with 
                                    even his own name being long forgotten.
                                    <br></br>
                                    <i><b>(Source: AnimeUKNews)</b></i></div>
            ...
            if (isset($_SESSION['id'])) {
                        $pos = $_SESSION['position'];
                         echo "<form method='POST' action='".setComments($conn)."'>
                                    <input type='hidden' name ='anime' value ='DKA'>
             ...
             <div class="slide">
              ...
              <div class="numbertext">1 / 4</div><img src="Images/preview1.png" style="width:100%"></div>
