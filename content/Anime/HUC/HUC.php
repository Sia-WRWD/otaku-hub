<?php
        ...
        include '../../../connection/AnimeComment/huc.ac.php';
?>
...
<head>
    ...
    <title>OtakuPage| Himouto! Umaru-chan</title>
</head>
    ...
    <br>
     ...
     <body>
		 ...
		 <div class="content-box" style="width:950px; margin:0 auto;">
             <div class="title"><h1>Himouto! Umaru-chan</h1></div>
			 <div class="image"><br><img src="Images/cover.png" alt="main_cover" style="width:350px;height:450px;"></div>
			 <div class="desc"><br>Umaru is a renowned beautiful 16-year-old girl in town, living with her elder brother Taihei. 
                                   She acts a perfect sister with a kind heart, intelligence and popularity, who everybody admires. 
                                   So who would believe how true Umaru is at home? Sleeping, gaming, watching TV, eating junk food, 
                                   drinking cola… that's almost all she does at home, leaving all the housework to her brother.
                                   <br></br>
                   ...
                   if (isset($_SESSION['id'])) {
                    $pos = $_SESSION['position'];
                     echo "<form method='POST' action='".setComments($conn)."'>
                                <input type='hidden' name ='anime' value ='HUC'>
