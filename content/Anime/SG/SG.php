<?php
        ...
        include '../../../connection/AnimeComment/sg.ac.php';
?>
...
<head>
    ...
    <title>OtakuPage| STEINS;GATE</title>
</head>
    ...
    <br>
     ...
     =<body>
		 ...
		 <div class="content-box" style="width:950px; margin:0 auto;">
             <div class="title"><h1>STEINS;GATE</h1></div>
			 <div class="image"><br><img src="Images/cover.png" alt="main_cover" style="width:350px;height:450px;"></div>
             <div class="desc"><br>Steins; Gate follows an eclectic group of individuals who have the ability to send text messages 
                                   to the past. However throughout their experimentation process, an organization named SERN who has 
                                   been doing their own research on time travel tracks them down. Now it’s a careful game of cat and 
                                   mouse to not get caught and moreover, try to survive.
                    ...
                    if (isset($_SESSION['id'])) {
                        $pos = $_SESSION['position'];
                         echo "<form method='POST' action='".setComments($conn)."'>
                                    <input type='hidden' name ='anime' value ='SG'>
