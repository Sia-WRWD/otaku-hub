<?php
        ...
        include '../../../connection/AnimeComment/knm.ac.php';
?>
...
<head>
    ...
    <title>OtakuPage| Knight's & Magic</title>
</head>
    ...
    <br>
     ...
     =<body>
		 ...
		 <div class="content-box" style="width:950px; margin:0 auto;">
             <div class="title"><h1>Knight's & Magic</h1></div>
			 <div class="image"><br><img src="Images/cover.png" alt="main_cover" style="width:350px;height:450px;"></div>
             <div class="desc"><br> A genius programmer and hardcore robot otaku is reborn into a world of knights and magic, 
                                    where huge robots called Silhouette Knights roar across the land! Now reborn as Ernesti Echevalier, 
                                    he uses his vast knowledge of machines and programming talents to begin to make his ultimate robot. 
                                    But his actions have unexpected results...?! The dreams of a robot otaku will change the world!
                                   <br></br>
                    ...
                    if (isset($_SESSION['id'])) {
                        $pos = $_SESSION['position'];
                         echo "<form method='POST' action='".setComments($conn)."'>
                                    <input type='hidden' name ='anime' value ='KNM'>
