<?php
        ...
        include '../../../connection/AnimeComment/kny.ac.php';
?>
...
<head>
    ...
    <title>OtakuPage| Kimetsu no Yaiba</title>
</head>
    ...
    <br>
     ...
     =<body>
		 ...
		 <div class="content-box" style="width:950px; margin:0 auto;">
             <div class="title"><h1>Kimetsu no Yaiba</h1></div>
			 <div class="image"><br><img src="Images/cover.png" alt="main_cover" style="width:350px;height:450px;"></div>
             <div class="desc"><br>It is the Taisho Period in Japan. Tanjiro, a kindhearted boy who sells charcoal for a living, finds his 
                                   family slaughtered by a demon. To make matters worse, his younger sister Nezuko, the sole survivor, has 
                                   been transformed into a demon herself. Though devastated by this grim reality, Tanjiro resolves to become 
                                   a “demon slayer” so that he can turn his sister back into a human, and kill the demon that massacred his 
                                   family.

                                   <br></br>
                                   <i><b>(Source: Crunchyroll)</b></i></div>
                    ...
                    if (isset($_SESSION['id'])) {
                        $pos = $_SESSION['position'];
                         echo "<form method='POST' action='".setComments($conn)."'>
                                    <input type='hidden' name ='anime' value ='KNY'>
             ...
             <div class="slide">
              ...
              <div class="mySlides fade"><div class="numbertext">2 / 4</div><img src="Images/preview2.png" style="width:100%"></div>
              <div class="mySlides fade"><div class="numbertext">3 / 4</div><img src="Images/preview3.png" style="width:100%"></div>
