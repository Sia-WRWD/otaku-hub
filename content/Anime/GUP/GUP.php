<?php
        ...
        include '../../../connection/AnimeComment/gup.ac.php';
?>
...
<head>
    ...
    <title>OtakuPage| Girls Und Panzer</title>
</head>
    ...
    <br>
     ...
     =<body>
		 ...
		 <div class="content-box" style="width:950px; margin:0 auto;">
             <div class="title"><h1>Girls Und Panzer</h1></div>
			 <div class="image"><br><img src="Images/GUP.png" alt="main_cover" style="width:350px;height:450px;"></div>
			 <div class="desc"><br>"Senshadou" is a traditional sport using World War II era tanks in elimination-based matches. 
                                    Widely practiced by women and girls alike, it's advertised as a form of art geared towards 
                                    making ladies more prominent in culture and appealing to men. Becoming a worldwide phenomenon over 
                                    time, the influence of senshadou leads to the creation of a world championship which will soon be held 
                                    in Japan.Miho Nishizumi, who comes from a lineage of well-respected senshadou specialists, 
                                    is at odds with the sport after a traumatic event led to her retirement and eventually a 
                                    rift to form between her and her family. To steer clear of the practice as much as possible, 
                                    she transfers to Ooarai Girls High School where the senshadou program has been abolished. 
                                    <br></br>
                                    However, with the news of the upcoming championships, the school revives their tankery program, and Miho 
                                    is pushed into joining.   Now, with the aid of some new friends, she must overcome her past and once again 
                                    take command of a squadron of tanks in an effort to save her school from closure, all while proving to her 
                                    family that the Nishizumi-style of senshadou is not solely about victory.
                                    <br></br>
                                    <i><b>(Source: MyAnimeList(MAL) Rewrite)</b></i></div>
            ...
            if (isset($_SESSION['id'])) {
                $pos = $_SESSION['position'];
                 echo "<form method='POST' action='".setComments($conn)."'>
                            <input type='hidden' name ='anime' value ='GUP'>
            ...
            ?>
             ...
             <div class="slide">
              ...
              <div class="numbertext">1 / 4</div><img src="Images/preview1.jpg" style="width:100%"></div>
              <div class="mySlides fade"><div class="numbertext">2 / 4</div><img src="Images/preview2.jpg" style="width:100%"></div>
              <div class="mySlides fade"><div class="numbertext">3 / 4</div><img src="Images/preview3.jpg" style="width:100%"></div>
              <div class="mySlides fade"><div class="numbertext">4 / 4</div><img src="Images/preview4.gif" style="width:100%"></div>
