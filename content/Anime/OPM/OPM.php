<?php
        ...
        include '../../../connection/AnimeComment/opm.ac.php';
?>
    ...
    <br>
     ...
     =<body>
		 ...
		 <div class="content-box" style="width:950px; margin:0 auto;">
             ...
             <div class="desc"><br>Saitama started out being a hero just for fun. After three years of “special” training, he became 
                                   so powerful that he can defeat opponents with a single punch. Now, alongside Genos, his faithful 
                                   cyborg disciple, Saitama is ready to begin his official duties as a professional hero working with 
                                   the Hero Association. However, the frequency of monster appearances is surging and it increasingly 
                                   appears as if the Great Seer Madame Shibabawa’s prediction about the Earth’s doom is coming true. 
                    ...
                    if (isset($_SESSION['id'])) {
                        $pos = $_SESSION['position'];
                         echo "<form method='POST' action='".setComments($conn)."'>
                                    <input type='hidden' name ='anime' value ='OPM'>
