<?php
        ...
        include '../../../connection/AnimeComment/sao.ac.php';
?>
...
<head>
    ...
    <title>OtakuPage| Sword Art Online: Alicization - War of Underworld</title>
</head>
    ...
    <br>
     ...
     <body>
		 ...
		 <div class="content-box" style="width:950px; margin:0 auto;">
             <div class="title"><h1>Sword Art Online: Alicization - <br>War of Underworld</h1></div>
			 <div class="image"><br><img src="Images/coverr.png" alt="main_cover" style="width:350px;height:450px;"></div>
			 <div class="desc"><br> Despite the defeat of Quinella—the pontifex of the Axiom Church—things have not seemed to calm down yet. 
                                    Upon contacting the real world, Kazuto "Kirito" Kirigaya finds out that the Ocean Turtle—a mega-float 
                                    controlled by Rath—was raided. Due to a sudden short-circuit caused by the raiders, Kirito's fluctlight is 
                                    damaged, leaving him comatose. Feeling insecure about the people at the Axiom Church, Alice brings the 
                                    unconscious Kirito back to their hometown—Rulid Village, disregarding her banishment due to an 
                                    unabsolved crime. Now, Alice is living an ordinary and peaceful life close by the village, 
                                    wishing for Kirito to wake up.
                                    <br></br>
                                    However, tragedy strikes when Alice notices that the Dark Territory has already started to invade the 
                                    Human Empire. Reassuming her previous alias, Alice Synthesis Thirty, she promises to defeat the Dark 
                                    Territory in order to defend the world that Kirito and Eugeo worked so hard to protect.
                                    <br></br>
                    ...
                    if (isset($_SESSION['id'])) {
                        $pos = $_SESSION['position'];
                         echo "<form method='POST' action='".setComments($conn)."'>
                                    <input type='hidden' name ='anime' value ='SAO'>
             ...
             <div class="slide">
              ...
              <div class="mySlides fade"><div class="numbertext">3 / 4</div><img src="Images/preview-3.jpeg" style="width:100%"></div>
              <div class="mySlides fade"><div class="numbertext">4 / 4</div><img src="Images/preview-4.gif" style="width:100%"></div>
